...
download_to_file('https://raw.githubusercontent.com/amrjava/Alfa/main/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/amrjava/Alfa/main/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
