...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1717439120,1614314857,1398830949}
print([[
...
var = "مبرمج السورس"
if tonumber(user_id) == tonumber(1717439120) then  
var = "مطور السورس"
...
print("it is Bot")
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "الفا")
local Texti = "↞ بوت + "..Namebot.." ☑️\n\n↞ اختصاصي حمايه الجروبات السوبر..\n↞ للتفعيل ارفعني مشرف وارسل تفعيل في الجروب ."
keyboard = {} 
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "الفا")
