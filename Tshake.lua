...
database:del(bot_id..'اسم الملف:Lock:Added:Me'..msg.chat_id_)  
send(msg.id_,'◍ تم تفعيل امر منو ضافني') 
return false
end
if text == 'تعطيل مين ضافني' and Owner(msg) then  
database:set(bot_id..'اسم الملف:Lock:Added:Me'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'◍ تم تعطيل امر مين ضافني') 
return false
end

if text and text:match("(.*)(مين ضافني)(.*)") then
if not database:get(bot_id..'اسم الملف:Lock:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'◍ انت منشئ المجموعه ') 
return false
end
local Added_Me = database:get(bot_id.."اسم الملف:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
send(msg.chat_id_, msg.id_,'◍ نت دخلت عن طريق الرابط متعملش نفسك كهم هه..😂💘') 
end
end,nil)
else
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᖱ.𝐃𝐞𝐯 𝐑𝐚𝐦𝐲.ᖲ ',url="t.me/Babaramy"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
