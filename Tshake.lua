...
download_to_file('https://raw.githubusercontent.com/amrjava/alfapro/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/amrjava/alfapro/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
