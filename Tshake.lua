...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then
   ...
   if text and text:match("^تنزيل مطور ثانوي (%d+)$") and Owner(msg) then
   ...
   if text == ("الثانوين") and Owner(msg) then
   ...
   if text == ("مسح الثانوين") and Owner(msg) then
...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url="http://t.me/AKJA0"},
...
local NumMsg = database:get(bot_id..'Tshake:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
llocal getbioY = getbio(msg.sender_user_id_)
ocal TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Tshake:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Tshake:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
