...
send(msg.chat_id_,msg.id_,"🧭╿ليست لدي صلاحية التثبيت يرجى الالاختبار قبل الدخول من الصلاحيات")  
end
end,nil) 
end
...
if text and text:match('^حذف (%d+)$') and Addictive(msg) and not database:get(bot_id..'lock:del'..msg.chat_id_) then    
...
if text == 'تعطيل الاختبار قبل الدخول' and Addictive(msg) then   
database:del(bot_id..'Tshake:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل الاختبار قبل الدخول' ) 
end
if text == 'تفعيل الاختبار قبل الدخول' and Addictive(msg) then  
database:set(bot_id..'Tshake:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل الاختبار قبل الدخول' ) 
end 
