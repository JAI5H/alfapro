...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Tshake(msg) then
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Add:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
if text and text:match("^رفع مطور ثانوي @(.*)$") and Addictive(msg) then
...
database:sadd(bot_id.."Add:Sudo:T", result.id_)
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and Addictive(msg) then
local userid = text:match("^رفع مطور ثانوي (%d+)$")
database:sadd(bot_id.."Add:Sudo:T", userid)
Reply_Status(msg,userid,"reply","• تم ترقيته مطور ثانوي في البوت")  
return false 
end
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Tshake(msg) then
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Add:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
if text and text:match("^حذف مطور ثانوي @(.*)$") and Addictive(msg) then
local username = text:match("^حذف مطور ثانوي @(.*)$")
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Add:Sudo:T", result.id_)
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and Tshake(msg) then
local userid = text:match("^حذف مطور ثانوي (%d+)$")
database:srem(bot_id.."Add:Sudo:T", userid)
Reply_Status(msg,userid,"reply","• تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانويين") and Addictive(msg) then
local list = database:smembers(bot_id.."Add:Sudo:T")
...
if text == ("مسح الثانويين") and Addictive(msg) then
database:del(bot_id.."Add:Sudo:T")
...
send(msg.chat_id_,msg.id_,"⚫️╿ليست لدي صلاحية التثبيت يرجى الالاختبار من الصلاحيات")  
end
end,nil) 
end
...
if text == "تفعيل الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."Tshake:Link_Group"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"✅╿تم تفعيل الرابط المجموعه") 
return false  
end
end
if text == "تعطيل الرابط" or text == 'تعطيل الرابط' then
if Addictive(msg) then  
...
if text == "طرد البوتات" and Addictive(msg) then 
...
send(msg.chat_id_, msg.id_,"⚫️╿ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Tshake:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"⚫️╿ارسل الكلمه التري تريد حذفها")
...
if text == "حذف رد عام" and DevTshake(msg) then 
send(msg.chat_id_, msg.id_,"⚫️╿ ارسل الكلمه التري تريد حذفها")
...
"\n\n📨╿ عدد رسائل ْالجروب : "..(msg.id_/2097152/0.5)..
...
"اسمي "..Namebot,
"قرفتني خد بالك هه",
"بوت فعينك ونت قليل الادب.",
"خير يبشه",
"اسمي "..Namebot,
"قلب اخوك",
"عطلاق حبيباااااااي",
"ها ",
"انت لو قدامي كنت فشختك"
}
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"⚫️╿تم الغاء تعين الايدي عام") 
return false  
end 
...
send(msg.chat_id_, msg.id_,"⚫️╿ تم مغادرة المجموعه") 
send(GP_ID[2], 0,"⚫️╿ تم مغادرة المجموعه بامر من مطور البوت") 
...
send(msg.chat_id_, msg.id_,"⚫️╿تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevTshake(msg) then  
database:set(bot_id.."Tshake:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "⚫️╿تم تعطيل مغادرة البوت") 
return false 
end
...
local Texting = {
'خد يستا معلوماتك اهي',
"خد بالك الايدي بتاعك مميز",
"الفا بيسلم عليك يبشه",
"احلا مسا عليك يابا",
"مش هقولك عليه",
"صوره فقلبي كد",
}
...
keyboard.inline_keyboard = {
{
{text = 'English', callback_data=msg.sender_user_id_.."/ideengphoto"},{text = 'عربي', callback_data=msg.sender_user_id_.."/idearpphoto"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'English', callback_data=msg.sender_user_id_.."/ideeng"},{text = 'عربي', callback_data=msg.sender_user_id_.."/idearp"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'English', callback_data=msg.sender_user_id_.."/ideeng1@"..Id},{text = 'عربي', callback_data=msg.sender_user_id_.."/idearp1@"..Id},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(texte).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_,"🛡╿اسرع واحد يبعت هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"⁉️╿اسرع واحد يحل الاسئله ⍖\n {"..name.."}")
return false
end
end
...
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","بطنجان"}
...
name = string.gsub(name,"بطنجان","🍆")
send(msg.chat_id_, msg.id_,"🛡╿اسرع واحد يبعت معنى السمايل ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"🛡╿اسرع واحد يبعت العكس ~ {"..name.."}")
return false
end
end
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_,"💠╿اول واحد يبعت الاختلاف ~ {"..name.."}")
return false
end
end
...
local Text = '⬅️╿عدد جهاتك المضافه * ↫ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
...
if Num == 0 then 
Text = "⚫️╿لم تلعب اي لعبه للحصول على جواهر"
else
...
if database:get(bot_id.."Tshak:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then   
return  
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك") 
end 
database:setex(bot_id..'Tshak:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true) 
...
if text == "تنظيف ْالجروبات" and DevTshake(msg) then
...
send(msg.chat_id_, msg.id_,"*💠╿ عذرا لا يوجد هاكذا ملف في ْ *\n") 
end
return false
end
...
local Text =[[
🔻╿ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴀʟғᴀ
•–––––––––☆––––––––•
🚨╿ᴛʜᴇ ʙᴇsᴛ sᴏᴜʀᴄᴇ ɪɴ ᴛᴇʟʏ
•–––––––––☆––––––––•
🔺╿sᴘᴇᴇᴅ , ᴀᴄᴄᴜʀᴀᴄʏ , sᴀғᴇᴛʏ
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and Owner(msg) then
local username = text:match("^رفع مطور ثانوي @(.*)$")
function Function_BOYKA(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and Owner(msg) then
local userid = text:match("^رفع مطور ثانوي (%d+)$")
database:sadd(bot_id.."Add:Sudo:T", userid)
Reply_Status(msg,userid,"reply","◍ تم ترقيته مطور ثانوي في البوت")  
return false 
end
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then
function Function_BOYKA(extra, result, success)
database:srem(bot_id.."Add:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◍ تم تنزيله من المطور ثانويين")  
end
...
if text and text:match("^تنزيل مطور ثانوي @(.*)$") and Owner(msg) then
...
if text == ("الثانويين") and Owner(msg) then
local list = database:smembers(bot_id.."Add:Sudo:T")
t = "\n◍ قائمة مطورين الثانويين للبوت \n═───═Owner═───═\n"
for k,v in pairs(list) do
...
if text == ("مسح الثانويين") and Owner(msg) then
database:del(bot_id.."Add:Sudo:T")
send(msg.chat_id_, msg.id_, "\n◍ تم مسح قائمة المطورين الثانويين  ")
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '◍ هو الخزير دا اللي ضافك ← '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,'◍ نت دخلت عبر الرابط اصحا كده يابا') 
end
end,nil)
else
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᖱ.𝐀𝐦𝐫 𝐉𝐚𝐯𝐚.ᖲ ',url="t.me/UU_ak0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᖱ.𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝.ᖲ ',url="t.me/Dev_Ah8"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᖱ.𝐃𝐞𝐯 𝐑𝐚𝐦𝐲.ᖲ ',url="t.me/Dev_RE9"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if Addictive(msg) then
local Text =[[
مرحبا بك عزيزي في اوامر المجموعه🚦
ـ•–––––––––☆–––––––––•ـ
◈ اوامر المدراء           ◈ اوامر الحمايه
◈ اوامر الادمني          ◈ اوامر التعطيل
◈ اوامر المطور           ◈ اوامر القفل
◈ اوامر المنشئ الاساسي.
ـ•–––––––––☆–––––––––•ـ
اختـر الامـر الذي تريـده مـن الأسـفـل.⬇️

ᴄʜᴀɴᴇʟ ➳ [ sᴏᴜʀᴄᴇ ᴀʟғᴀ](https://t.me/AKJA0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'اوامر المنشئ الاساسي', callback_data=msg.sender_user_id_.."/help4"},
},
{
{text = 'اوامر المطور ', callback_data=msg.sender_user_id_.."/help5"},
},
{
...
🔐╿السيلفي
«|■□■□■□■□■□■□■□■|»
ᴄʜ » [ sᴏᴜʀᴄᴇ ᴀʟғᴀ](https://t.me/AKJA0)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'اوامر المنشئ الاساسي' and Constructor(msg) then
Text = [[
...
if text == 'اوامر المطور ' and DevBot(msg) then
Text = [[
...
if text == '/start' then  
if DevTshake(msg) then
local Text = '❗️شكرا لاستخدامك سورس الفا انت المطور الاساسي وهنا الاوامر المجهزه لك💻.'
local keyboard = {
{'الاحصائيات 📊'},
{'تفعيل التواصل ⚡','تعطيل التواصل 🛡'},
{'تنظيف ْالجروبات ℹ','تنظيف المشتركين ♠'},
...
Test = '• مرحبا عزيزي انا بوت حمايه\n• اختصاصي حمايه المجموعه من الاشياء التي تضرها\n• كل ما عليك فعله رفعي مشرف بمجموعتك واكتب كلمه " تفعيل" \n• مطور البوت ['..UserName..']'
end 
send(msg.chat_id_, msg.id_, Test) 
end
end
...
if text == "تنظيف ْالجروبات ℹ" then
local group = database:smembers(bot_id..'Tshake:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
keyboard.inline_keyboard = {
{
{text = 'English', callback_data=data.sender_user_id_.."/ideengphoto"},{text = 'عربي', callback_data=data.sender_user_id_.."/idearpphoto"},
},
}
...
keyboard.inline_keyboard = {
{
{text = 'English', callback_data=data.sender_user_id_.."/ideeng1@"..Id},{text = 'عربي', callback_data=data.sender_user_id_.."/idearp1@"..Id},
},
}
...
keyboard.inline_keyboard = {
{
{text = 'English', callback_data=data.sender_user_id_.."/ideeng"},{text = 'عربي', callback_data=data.sender_user_id_.."/idearp"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(texte)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end,nil)   
...
{
{text = 'اوامر المنشئ الاساسي', callback_data=data.sender_user_id_.."/help4"},
},
{
{text = 'اوامر المطور ', callback_data=data.sender_user_id_.."/help5"},
},
{
...
local Teext =[[
مرحبا بك عزيـزي في اوامـر المجموعـه.🚦
ـ•–––––––––☆–––––––––•ـ
𖣄 اوامر المدراء           𖣄 اوامر الحمايه
𖣄 اوامر الادمني          𖣄 اوامر التعطيل
𖣄 اوامر المطور           𖣄 اوامر القفل.
𖣄 اوامر المنشئ الاساسي.
ـ•–––––––––☆–––––––––•ـ
اختـر الامـر الذي تريـده مـن الأسـفـل.⬇️
ㅤ
ᴄʜᴀɴᴇʟ ➳ [ sᴏᴜʀᴄᴇ ᴀʟғᴀ](https://t.me/AKJA0)
...
keyboard.inline_keyboard = {
{
{text = '🔙 الاوامر الرئيسيه 🔙', callback_data=data.sender_user_id_.."/homeaddrem"},
},
}
...
{
{text = '🔙 رجوع الي الخلف 🔙', callback_data=data.sender_user_id_.."/help"},
},
}
...
keyboard.inline_keyboard = {
{
{text = '🔙 الاوامر الرئيسيه 🔙', callback_data=data.sender_user_id_.."/homelocks"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
if text == 'تعطيل الاختبار' and Addictive(msg) then   
database:del(bot_id..'Tshake:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل الاختبار' ) 
end
if text == 'تفعيل الاختبار' and Addictive(msg) then  
...
print("it is Bot")
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "الفا")
local Texti = "انا بوت "..Namebot.." 🤖\n\n⚚ اختصاصي حمايه المجموعات🛡..\n⚚ للتفعيل قم برفعي مشرف وارسل تفعيل في الجروب🚦 ."
keyboard = {} 
keyboard.inline_keyboard ={{{text = "اضف البوت الي مجموعتك☑️", switch_inline_query="بوت حمايه المجموعات ضيفني الي مجموعتك لكي اعمل علي حمايتها ."}}}
local msg_id = msg.id_/2097152/0.5
