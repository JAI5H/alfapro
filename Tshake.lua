...
Namebotr = randomrd_Msg[math.random(#randomrd_Msg)] 
local function getpro(extra, result, success) 
if result.photos_[0] then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,Namebotr, msg.id_, msg.id_, "md") 
else 
send(msg.chat_id_, msg.id_,Namebotr, 1, 'md') 
end 
end 
