...
send(msg.chat_id_, msg.id_,"ᳱ  الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end -- end
...
sendtext(chat,msg.id_,"ᳱ ملف النسخه الاحتياطيه ليس لهاذا البوت")   
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot' .. token .. '/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_,"ᳱ جاري ...\nᳱ رفع الملف الان")   
else
sendtext(chat,msg.id_,"*ᳱ عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")   
end      
...
send(chat,msg.id_,"ᳱ تم رفع الملف بنجاح وتفعيل المجموعات\nᳱ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")   
end

function Is_Not_Spam(msg,type)
if type == "kick" then 
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ قام بالتكرار هنا وتم طرده")  
...
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ قام بالتكرار هنا وتم تقييده")  
return false  
end  
if type == "mute" then
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ قام بالتكرار هنا وتم كتمه")  
database:sadd(bot_id.."Tshake:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
send(msg.chat_id_,msg.id_,"ᳱ  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end
...
send(msg.chat_id_,msg.id_,"ᳱ  تم تغيير المطور الاساسي للبوت بنجاح .")
database:del(bot_id..":usernewsudo:"..msg.sender_user_id_)
dofile('Tshake.lua')  
else
send(msg.chat_id_, msg.id_,"ᳱ  لا يوجد حساب بهاذا المعرف")
end
end
...
local Text = "ᳱ  سوف يتم تغير المطور الاساسي\n❗️ هل  انت  متأكد من هذا التغير ؟"
keyboard = {} 
...
send(msg.chat_id_, msg.id_,"ᳱ تم الغاء الاذاعه") 
...
send(msg.chat_id_, msg.id_,"ᳱ تمت الاذاعه الى *~ "..#list.." ~* مجموعه ")     
database:del(bot_id.."Tshake:Tshake:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ  تم منع الملصق هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ  تم منع الصوره هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ  تم منع المتحركه هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"ᳱ ليس لدي صلاحية تغيير معلومات المجموعه يرجى المحاوله لاحقا") 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,"ᳱ تم تغيير صورة المجموعه") 
end
end, nil) 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,"ᳱ تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Tshake:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"ᳱ تم الغاء حفظ الرابط")       
...
send(msg.chat_id_,msg.id_,"ᳱ تم حفظ الرابط بنجاح")       
database:del(bot_id.."Tshake:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"ᳱ تم الغاء الاذاعه للخاص") 
...
send(msg.chat_id_, msg.id_,"ᳱ تمت الاذاعه الى *~ "..#list.." ~* مشترك في الخاص ")     
database:del(bot_id.."Tshake:Tshake:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
if Tshake_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","ᳱ "..Tshake_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ ارسل الامر الجديد")  
...
send(msg.chat_id_, msg.id_,"ᳱ تم حفظ الامر")  
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل الدردشه")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل اضافة الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل دخول الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل البوتات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lockkick","ᳱ تم قفـل البوتات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل الاشعارات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل التثبيت هنا")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل تعديل")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","ᳱ تم قفـل جميع الاوامر")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فتح اضافة الاعضاء")  
return false
end 
if text == "فتح الدردشه" and msg.reply_to_message_id_ == 0 and Owner(msg) then 
database:del(bot_id.."Tshake:Lock:text"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فتح الدردشه")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فتح دخول الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فـتح البوتات")  
return false
end 
if text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:del(bot_id.."Tshake:Lock:Bot:kick"..msg.chat_id_)  
...
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فـتح الاشعارات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فـتح التثبيت هنا")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","ᳱ تم فـتح تعديل")  
return false
end 
...
if text == 'تعطيل all' and Addictive(msg) then  
...
send(msg.chat_id_, msg.id_, "ᳱ لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "ᳱ لا تسطيع حظر البوت عام")
return false 
end
database:sadd(bot_id.."Tshake:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم حظره عام من المجموعات")  
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم حظره عام من المجموعات")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
function Function_Tshake(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","ᳱ تم الغاء حظره عام من المجموعات")  
...
Reply_Status(msg,userid,"reply","ᳱ تم الغاء حظره عام من المجموعات")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته مطور في البوت")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم ترقيته مطور في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم تنزيله من المطورين")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم تنزيله من المطورين")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تنزيله من المالك")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته مالك")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته مالك")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته منشئ اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته منشئ اساسي")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم ترقيته منشئ اساسي")  
return false
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,userid,"reply","ᳱ تم تنزيله من المنشئين")  
return false
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته منشئ في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته منشئ في المجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم ترقيته منشئ في المجموعه")  
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته مدير المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end  
...
send(msg.chat_id_, msg.id_,"ᳱ تم ازالة 100 من وسائط ") 
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته مدير المجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم ترقيته مدير المجموعه")  
return false
end  
if text == ("تنزيل مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) then 
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Tshake:Manager"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تنزيله من المدراء")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end  
...
Reply_Status(msg,result.id_,"reply","ᳱ تم تنزيله من المدراء")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم تنزيله من المدراء")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته ادمن للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته ادمن للمجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم ترقيته ادمن للمجموعه")  
return false
end
if text == ("تنزيل ادمن") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then 
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Tshake:Mod:User"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم تنزيله من ادمنيه المجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم تنزيله من ادمنيه المجموعه")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم ترقيته مميز للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم ترقيته مميز للمجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم ترقيته مميز للمجموعه")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تنزيله من المميزين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم تنزيله من المميزين")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم تنزيله من المميزين")  
return false
end  
...
send(msg.chat_id_, msg.id_,"\nᳱ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᳱ تم رفعه "..RTPA.." هنا\n")   
...
if Tshakert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\nᳱ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\nᳱ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Tshake:Special:User"..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'ᳱ لقد تم تعطيل الحظر و الطرد من قبل المنشئين')
return false
end
function Function_Tshake(extra, result, success)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\nᳱ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(result.sender_user_id_,msg.chat_id_).." )")
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"ᳱ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم حظره من المجموعه")  
end,nil)   
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
...
send(msg.chat_id_, msg.id_, "\nᳱ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(result.id_,msg.chat_id_).." )")
else
...
Reply_Status(msg,result.id_,"reply","ᳱ تم حظره من المجموعه")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_, "ᳱ لا يوجد حساب بهاذا المعرف")
...
send(msg.chat_id_, msg.id_, "\nᳱ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(userid,msg.chat_id_).." )")
else
...
Reply_Status(msg,userid,"reply","ᳱ تم حظره من المجموعه")  
end,nil)   
end
return false
end
...
function Function_Tshake(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, "ᳱ انا لست محظورا \n") 
return false 
end
database:srem(bot_id.."Tshake:Ban:User"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم الغاء حظره من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم الغاء حظره من هنا")  
else
send(msg.chat_id_, msg.id_, "ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم الغاء حظره من هنا")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم كتمه من هنا")  
else
send(msg.chat_id_, msg.id_, "ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم كتمه من هنا")  
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم الغاء كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم الغاء كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم الغاء كتمه من هنا")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم تقييده في المجموعه")  
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
...
Reply_Status(msg,result.id_,"reply","ᳱ تم تقييده في المجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم تقييده في المجموعه")  
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply", "ᳱ تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Reply_Status(msg,result.id_,"reply", "ᳱ تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
------------------------------------------------------------------------
if text and text:match('^كتم (%d+) (.*)$') and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
...
Reply_Status(msg,result.sender_user_id_,"reply", "ᳱ تم كتمه لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
...
Reply_Status(msg,result.id_,"reply", "ᳱ تم كتمه لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_..'&until_date='..tonumber(msg.date_+Time))
end
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم الغاء تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","ᳱ تم الغاء تقييده")  
else
send(msg.chat_id_, msg.id_, "ᳱ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","ᳱ تم الغاء تقييده")  
return false
end
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","ᳱ تم طرده من هنا")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
...
Kick_Group(msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","ᳱ تم طرده من هنا")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_, "ᳱ لا يوجد حساب بهاذا المعرف")
...
Kick_Group(msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","ᳱ تم طرده من هنا")  
end,nil)   
end
return false
end
...
send(msg.chat_id_, msg.id_, 'ᳱ تم تعطيل » الحظر ~ والطرد ')
return false
end
end
...
send(msg.chat_id_, msg.id_, 'ᳱ تم تفعيل » الحظر ~ والطرد ')
return false
end
end
...
send(msg.chat_id_, msg.id_, 'ᳱ تم تعطيل رفع » الادمن ~ المميز ')
return false
end
end
...
send(msg.chat_id_, msg.id_, 'ᳱ تم تفعيل رفع » الادمن ~ المميز ')
return false
end
end
...
send(msg.chat_id_,msg.id_,"ᳱ التثبيت والغاء التثبيت تم قفله من قبل المنشئين")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"ᳱ تم تثبيت الرساله")   
database:set(bot_id.."Tshake:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"ᳱ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"ᳱ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"ᳱ تم الغاء تثبيت الرساله")   
...
send(msg.chat_id_, msg.id_,"ᳱ تم وضع عدد التكرار ("..Num..")")  
end 
...
send(msg.chat_id_,msg.id_,"ᳱ ارسل رابط المجموعه او رابط قناة المجموعه")
...
send(msg.chat_id_, msg.id_,"ᳱ تم تفعيل جلب الرابط المجموعه") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم تعطيل جلب رابط المجموعه") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Tshake:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"ᳱ جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."Tshake:Private:Group:Link"..msg.chat_id_)            
if link then                              
send(msg.chat_id_,msg.id_,"ᳱ رابط المجموعة ~\n ["..link.."]")                          
else                
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد رابط ارسل ضع رابط")              
end            
end
if text == "مسح الرابط" or text == "حذف الرابط" then
if Addictive(msg) then     
send(msg.chat_id_,msg.id_,"ᳱ تم مسح الرابط ")           
...
send(msg.chat_id_, msg.id_,"ᳱ تم ازالة صورة المجموعه") 
end
return false  
end
...
send(msg.chat_id_, msg.id_,"ᳱ ارسل الان الوصف")
end
return false  
end
...
t  = "ᳱ ارسل لي الترحيب الان"
tt = "\nᳱ تستطيع اضافة مايلي !\nᳱ دالة عرض الاسم »{`name`}\nᳱ دالة عرض المعرف »{`user`}"
...
send(msg.chat_id_, msg.id_,"ᳱ تم مسح قائمه المنع")  
end
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ᳱ ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_,"ᳱ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Tshake:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,"ᳱ ارسل الكلمه الان")  
database:set(bot_id.."Tshake:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Tshake:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"ᳱ تم الغاء منعها ")  
database:del(bot_id.."Tshake:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "ᳱ لا توجد بوتات في المجموعه")
else
local t = "ᳱ عدد البوتات هنا >> {"..c.."}\nᳱ عدد البوتات التي هي ادمن >> {"..x.."}\nᳱ تم طرد >> {"..(c - x).."} من البوتات"
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \nᳱ عدد البوتات التي هنا >> {"..n.."} بوت\n"
local f = "ᳱ عدد البوتات التي هي ادمن >> {"..t.."}\nᳱ ملاحضه علامة ال (✯) تعني ان البوت ادمن \n💥"
...
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "ᳱ تم الغاء حفظ القوانين") 
...
send(msg.chat_id_, msg.id_,"ᳱ تم حفظ قوانين المجموعه") 
database:del(bot_id.."Tshake:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_,"ᳱ ارسل لي القوانين الان")  
end
end
if text == "مسح القوانين" or text == "حذف القوانين" then  
if Addictive(msg) then
send(msg.chat_id_, msg.id_,"ᳱ تم ازالة قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_,"ᳱ تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."Tshake:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"ᳱ الان ارسل لي الامر القديم ..")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."Tshake:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"ᳱ ارسل الامر الذي قم بوضعه بدلا عن القديم")  
return false
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,"ᳱ لا توجد صلاحيات مضافه")
return false
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم مسح الصلاحيات")
end
...
send(msg.chat_id_, msg.id_, "ᳱ ارسل نوع الصلاحيه ⚜️\n📊(عضو ~ مميز  ~ ادمن  ~ مدير )") 
end
...
send(msg.chat_id_, msg.id_,"ᳱ  تم تغير رد المطور الى » "..Teext)
end
...
send(msg.chat_id_, msg.id_,"ᳱ  تم تغير رد المنشئ الاساسي الى » "..Teext)
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم مسح ردود المدير")
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم حفظ الرد بنجاح")
return false  
end  
end
if text == "اضف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"ᳱ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Tshake:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"ᳱ ارسل الكلمه التري تريد حذفها")
...
send(msg.chat_id_, msg.id_, 'ᳱ الان ارسل الرد الذي تريد اضافته \nᳱ  قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\nᳱ  يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
...
send(msg.chat_id_, msg.id_,"ᳱ تم ازالة الرد من قائمه الردود")
database:del(bot_id.."Tshake:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Tshake:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Tshake:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Tshake:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,"ᳱ تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم ازالة الرد من قائمه ردود المطور")
...
send(msg.chat_id_, msg.id_,'ᳱ تم طرد الحسابات المحذوفه')
end,nil)
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ  لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\nᳱ تم تنزيل الشخص من الرتب التاليه \nᳱ  { "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." } \n")
else
...
send(msg.chat_id_, msg.id_,"ᳱ  رتبتك في البوت » "..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = "ᳱ  اسمك الاول ← {`"..(result.first_name_).."`}"
else
first_name = ""
end   
if result.last_name_ then 
last_name = "ᳱ  اسمك الثاني ← {`"..result.last_name_.."`}" 
else
last_name = ""
end      
...
if text==("عدد المجموعه") and Addictive(msg) then  
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_,"ᳱ  البوت ليس ادمن هنا \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
local taha = "ᳱ  عدد الادمنيه : "..data.administrator_count_..
"\n\nᳱ  عدد المطرودين : "..data.kicked_count_..
"\n\nᳱ  عدد الاعضاء : "..data.member_count_..
"\n\nᳱ  عدد رسائل المجموعه : "..(msg.id_/2097152/0.5)..
...
send(msg.chat_id_, msg.id_, "\nᳱ  عذرا لا استطيع طرد ( "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." )")
return false
end
...
send(msg.chat_id_, msg.id_,"ᳱ  البوت ليس ادمن يرجى ترقيتي !") 
return false  
end
if data and data.code_ and data.code_ == 400 and data.message_ == "USER_ADMIN_INVALID" then 
send(msg.chat_id_, msg.id_,"ᳱ  عذرا لا استطيع طرد ادمنية المجموعه") 
return false  
end
if data and data.ID and data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"ᳱ  تم طردك من المجموعه ") 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,"ᳱ  امر اطردني تم تعطيله من قبل المدراء ") 
end
end
...
database:srem(bot_id.."Tshake:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."Tshake:Muted:User"..msg.chat_id_,result.id_)
usertext = "\nᳱ  العضو » ["..result.title_.."](t.me/"..(username or "kenwa")..")"
status  = "\nᳱ  تم الغاء القيود عنه"
...
database:srem(bot_id.."Tshake:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\nᳱ  العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "kenwa")..")"
status  = "\nᳱ  تم الغاء القيود عنه"
...
send(msg.chat_id_, msg.id_,"ᳱ  الحظر العام » "..GBan.."\nᳱ  الحظر » "..Ban.."\nᳱ  الكتم » "..Muted)
else
send(msg.chat_id_, msg.id_,"ᳱ  المعرف غلط")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Tshake, nil)
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"ᳱ  ليست لدي صلاحية تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_,"ᳱ  تم تغيير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"ᳱ  تمت ترقية { "..num2.." } من ادمنية المجموعه") 
end
end,nil)   
end
if text ==("المنشئ") then
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_,"ᳱ  حساب المنشئ محذوف")
return false  
end
...
send(msg.chat_id_, msg.id_,"ᳱ  تم مغادرة المجموعه") 
...
send(msg.chat_id_, msg.id_,"ᳱ  تم مغادرة المجموعه") 
send(GP_ID[2], 0,"ᳱ  تم مغادرة المجموعه بامر من مطور البوت") 
...
send(msg.chat_id_, msg.id_,"ᳱ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevTshake(msg) then  
database:set(bot_id.."Tshake:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "ᳱ تم تعطيل مغادرة البوت") 
return false 
end
...
send(msg.chat_id_, msg.id_,"ᳱ  ارسل لي الاسم الان ")  
end
return false
end
...
send(msg.chat_id_, msg.id_, "ᳱ  يرجى ترقيتي ادمن هنا") 
return false
end  
local num = 0 
...
send(msg.chat_id_, msg.id_,"ᳱ  تم الغاء الحظر عن *~ "..num.." ~* اشخاص ") 
end    
...
send(msg.chat_id_, msg.id_,"ᳱ الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."Tshake:Tshake:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"ᳱ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\nᳱ للخروج ارسل الغاء ") 
return false
end 
...
send(msg.chat_id_, msg.id_,"ᳱ ارسل لي التوجيه الان") 
return false
end 
...
"*\nᳱ ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\nᳱ علامة ال {✓} تعني مفعل"..
"\n🔓علامة ال {✘} تعني معطل"..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\nᳱ الروابط » "..lock_links..
"\n".."ᳱ المعرفات » "..lock_user..
"\n".."ᳱ التاك » "..lock_hash..
"\n".."ᳱ البوتات » "..lock_bots..
"\n".."ᳱ التوجيه » "..lock_fwd..
"\n".."ᳱ التثبيت » "..lock_pin..
"\n".."ᳱ الاشعارات » "..lock_tagservr..
"\n".."ᳱ الماركدون » "..lock_mark..
"\n".."ᳱ التعديل » "..lock_edit..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n".."ᳱ الكلايش » "..lock_spam..
"\n".."ᳱ الكيبورد » "..lock_inlin..
"\n".."ᳱ الاغاني » "..lock_vico..
"\n".."ᳱ المتحركه » "..lock_gif..
"\n".."ᳱ الملفات » "..lock_file..
"\n".."ᳱ الدردشه » "..lock_text..
...
send(msg.chat_id_, msg.id_, 'ᳱ تم ازالة كليشة الايدي ')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"ᳱ تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,'ᳱ تم تعين الايدي')    
end
...
send(msg.chat_id_, msg.id_,'ᳱ تم تنظيف *~ '..Number..'* رساله .')  
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,'ᳱ  الحساب محذوف لا توجد معلوماته ')
return false
end
if data.username_ then
UserName_User = '@'..data.username_
...
send(msg.chat_id_, msg.id_,'*ᳱ ايديه - '..Id..'\nᳱ رسائله - '..NumMsg..'\nᳱ معرفه - *['..UserName_User..']*\nᳱ تفاعله - '..TotalMsg..'\n🚸رتبته - '..Status_Gps..'\n⚡تعديلاته - '..message_edit..'\nᳱ جهاته - '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
...
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","ᳱ ","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","ᳱ ","📍","📓","📗","📂","📅","📪","ᳱ ","ᳱ ","📭","⏰","📺","🎚","☎️","ᳱ "}
SM = Random[math.random(#Random)]
database:set(bot_id.."Tshak:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يرتبها ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"🎁الف مبروك لقد فزت \nᳱ للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يحل الحزوره ↓\n {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يدز معنى السمايل ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يدز العكس ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,"ᳱ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸تم اضافة { 5 } من النقاط \n")
...
database:del(bot_id.."Tshak:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."Tshak:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"ᳱ اوبس لقد خسرت في اللعبه \nᳱ حظآ اوفر في المره القادمه \nᳱ كان الرقم الذي تم تخمينه { "..GETNUM.." }")
else
send(msg.chat_id_, msg.id_,"ᳱ اوبس تخمينك غلط \nᳱ ارسل رقم تخمنه مره اخرى ")
end
end
end
end
...
send(msg.chat_id_, msg.id_,"\nᳱ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."ᳱ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."ᳱ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
send(msg.chat_id_, msg.id_,"ᳱ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
...
send(msg.chat_id_, msg.id_,"ᳱ مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n🎊لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
database:incrby(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."Tshak:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"ᳱ للاسف لقد خسرت \nᳱ المحيبس بل ايد رقم { "..GETNUM.." }\n💥حاول مره اخرى للعثور على المحيبس")
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
ᳱ اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
...
name = string.gsub(name,"👨‍🔬","👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👨‍🔬👩‍🔬👩‍🔬👩‍🔬")
name = string.gsub(name,"👨‍💻","👩‍💻👩‍💻👩‍‍💻👩‍‍💻👩‍💻👨‍💻👩‍💻👩‍💻👩‍💻")
name = string.gsub(name,"👨‍ᳱ ","👩‍ᳱ 👩‍ᳱ 👩‍ᳱ 👩‍ᳱ 👩‍ᳱ 👩‍ᳱ 👨‍ᳱ 👩‍ᳱ ")
name = string.gsub(name,"👩‍🍳","👨‍🍳👨‍🍳👨‍🍳👨‍🍳👨‍🍳👩‍🍳👨‍🍳👨‍🍳👨‍🍳")
name = string.gsub(name,"🧚‍♀","🧚‍♂🧚‍♂🧚‍♂🧚‍♂🧚‍♀🧚‍♂🧚‍♂")
name = string.gsub(name,"🧜‍♂","🧜‍♀🧜‍♀🧜‍♀🧜‍♀🧜‍♀🧚‍♂🧜‍♀🧜‍♀🧜‍♀")
name = string.gsub(name,"🧝‍♂","🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♂🧝‍♀🧝‍♀🧝‍♀")
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يدز الاختلاف ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"ᳱ اسرع واحد يكمل المثل ~ {"..name.."}")
return false
end
end
...
Teext = [[
ᳱ قائمه الالعاب الموجوده
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
ᳱ لعبة البات » بات
ᳱ لعبة التخمين » خمن
ᳱ لعبه الاسرع » الاسرع
ᳱ لعبة السمايلات » سمايلات
ᳱ لعبة المختلف » المختلف
ᳱ لعبة الامثله » امثله
ᳱ لعبة العكس » العكس 
ᳱ لعبة الحزوره » حزوره
ᳱ لعبة المعاني » معاني
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
ᳱ مجوهراتي » لعرض عدد الارباح
...
if Num == 0 then 
Text = "ᳱ لم تلعب اي لعبه للحصول على جواهر"
else
Text = "ᳱ عدد جواهر التي رحبتها هي *~ { "..Num.." } مجوهره *"
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n*ᳱ لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"ᳱ ليس لديك جواهر من الالعاب \nᳱ اذا كنت تريد ربح الجواهر \nᳱ ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = database:get(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\nᳱ ليس لديك جواهر بهاذا العدد \nᳱ لزيادة مجوهراتك في اللعبه \nᳱ ارسل الالعاب وابدأ اللعب !") 
return false 
end
...
send(msg.chat_id_,msg.id_,"ᳱ تم خصم *~ { "..NUMPY.." }* من مجوهراتك \nᳱ وتم اضافة* ~ { "..(NUMPY * 50).." } رساله الى رسالك *")
end 
return false 
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم اضافة له {"..numadded.."} من الرسائل")  
end
...
send(msg.chat_id_, msg.id_,"ᳱ تم اضافة له {"..numadded.."} من المجوهرات")  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, "ᳱ ارسل لي عدد المجوهرات الان") 
return false
end
if text and text:match("^اضف مجوهرات (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_,"ᳱ تم اضافة له {"..Num.."} من المجوهرات")  
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'ᳱ لا يوجد مشتركين وهميين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*ᳱ عدد المشتركين الان ~ '..#pv..'\nᳱ تم العثور على ~ '..sendok..' مشترك قام بحظر البوت\nᳱ اصبح عدد المشتركين الان ~ '..ok..' مشترك *')   
end
end
end,nil)
end,nil)
...
if text == "تنظيف المجموعات" and DevTshake(msg) then
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'ᳱ لا توجد مجموعات وهميه ')   
else
local taha = (w + q)
...
taha = '\nᳱ  تم ازالة ~ '..q..' مجموعات من البوت'
end
if w == 0 then
storm = ''
else
storm = '\nᳱ  تم ازالة ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*?? عدد المجموعات الان ~ '..#group..' مجموعه '..storm..''..taha..'\nᳱ اصبح عدد المجموعات الان ~ '..sendok..' مجموعات*\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,'ᳱ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevTshake(msg) then  
database:set(bot_id..'Tshake:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'ᳱ تم تعطيل البوت الخدمي') 
end
...
send(msg.chat_id_, msg.id_,'ᳱ  تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
...
send(msg.chat_id_, msg.id_,'ᳱ احصائيات البوت \n\nᳱ عدد المجموعات *~ '..Groups..'\nᳱ عدد المشتركين ~ '..Users..'*')
end
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./File_Libs/'..bot_id..'.json', 'ᳱ  عدد مجموعات التي في البوت { '..#list..'}')
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMTshakeX/files_tshake/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📂اهلا بك في متجر ملفات تشاكيx \nᳱ الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\nᳱ تدل علامة (✔) الملف مفعل\n".."ᳱ تدل علامة (✖) الملف معطل\n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"ᳱ  لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
if file_bot then
io.close(file_bot)
t = "*ᳱ  الملف » {"..file.."}\nᳱ  تم تعطيله وحذفه بنجاح *"
else
t = "*ᳱ  بالتاكيد تم تعطيل وحذف ملف » {"..file.."} *"
end
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMTshakeX/files_tshake/main/files_tshake/"..file)
if res == 200 then
os.execute("rm -fr Tshake_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DDDDiD.lua')  
else
send(msg.chat_id_, msg.id_,"*ᳱ  عذرا لا يوجد هاكذا ملف في المتجر *") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = "*ᳱ  بالتاكيد تم تنزيل وتفعيل ملف » {"..file.."} *"
else
t = "*ᳱ  الملف » {"..file.."}\nᳱ  تم تنزيله وتفعيله بنجاح *"
end
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMTshakeX/files_tshake/main/files_tshake/"..file)
if res == 200 then
...
send(msg.chat_id_,msg.id_,"ᳱ تم حذف جميع الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,'ᳱ تم نقل : '..#Groups..' مجموعه\nᳱ تم نقل : '..#Users..' مشترك \nᳱ من التحديث القديم الى التحديث الجديد')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nᯓ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOYKA')..') '
status  = '\nᯓ تم اضافه {'..timsh..'} لقب له'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'ᯓ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nᯓ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uu_iv')..')'
status  = '\nᯓ الايدي » `'..result.sender_user_id_..'`\nᯓ تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
end,nil)
end
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"ᯓ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end      
usertext = '\nᯓ العضو » ['..result.title_..'](t.me/'..(username or 'uu_iv')..')'
status  = '\nᯓ تم رفعه مشرف '
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, 'ᯓ لا يوجد حساب بهاذا المعرف')
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nᯓ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uu_iv')..')'
status  = '\nᯓ الايدي » '..result.sender_user_id_..'\nᯓ تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,'ᳱ  تم حذف كليشه المطور')
end
...
send(msg.chat_id_,msg.id_,'ᳱ  ارسل الكليشه الان')
return false
end
...
send(msg.chat_id_,msg.id_,'ᳱ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'Tshake:Text_Dev',text)
database:del(bot_id..'Tshake:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'ᳱ تم حفظ كليشة المطور')
return false
end
...
if Addictive(msg) then
local Text =[[
〝 يوجد في البوت 5 قوائم للأوامر 〞
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
ُ𓆩 م1 تخص اوامر الحماية  𓆪
ُ𓆩 م2 تخص الادمنيه 𓆪
ُ𓆩 م3 تخص المدراء  𓆪
ُ𓆩 م4 تخص المنشئين 𓆪
ُ𓆩 م5 تخص المطورين𓆪
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
Ch ← [ 𝘴ꪮꪊ𝘳ᥴꫀ  𝘳ꫀꪜꪮ𝘳](t.me/revorb0t)
]]
keyboard = {} 
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
ᳱ قفل/فتح + الاوامر الادناه 
ᳱ قفل/فتح + الامر بالتقيد • بالطرد • بالكتم
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
ᳱ الروابط
ᳱ المعرف
ᳱ التاك
...
ᳱ تفعيل/تعطيل الايدي بالصوره
ᳱ تفعيل/تعطيل الايدي
ᳱ تفعيل/تعطيل ردود المطور
ᳱ تفعيل/تعطيل اللعبه/الالعاب
ᳱ تفعيل/تعطيل ردود المدير
ᳱ تفعيل/تعطيل اطردني
ᳱ تفعيل/تعطيل الرفع
ᳱ تفعيل/تعطيل الحظر/الطرد
ᳱ تفعيل/تعطيل الرابط/جلب الرابط
ᳱ تفعيل/تعطيل اوامر التحشيش
ᳱ تفعيل/تعطيل التنزيل
ᳱ تعين/مسح الايدي
ᳱ تفعيل/تعطيل @all
ᳱ رفع الادمنيه
ᳱ اضف/حذف رد
...
ᳱ اضف/حذف امر
ᳱ الاوامر المضافه
ᳱ حذف/مسح الاوامر المضافه
ᳱ اضف رسائل + العدد بالرد
ᳱ اضف مجوهرات + العدد بالرد
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
Ch ← [ 𝘴ꪮꪊ𝘳ᥴꫀ  𝘳ꫀꪜꪮ𝘳](t.me/revorb0t)
]]
send(msg.chat_id_, msg.id_,Text)
...
ᳱ مسح ردود المطور
ᳱ ردود المطور 
ᳱ وضع /حذف كليشه المطور 

ᳱ تحديث  + تحديث السورس 

ᳱ تفعيل/تعطيل البوت الخدمي 
ᳱ  تعين عدد الاعضاء + العدد
ᳱ تفعيل/تعطيل المغادرة
ᳱ تفعيل/تعطيل الاذاعه 
ᳱ تفعيل/تعطيل ملف + اسم الملف
ᳱ الملفات 
ᳱ مسح جميع الملفات 
ᳱ المتجر 
ᳱ اوامر المطور 
...
ᳱ رفع/تنزيل مالك 
ᳱ رفع/تنزيل منشئ اساسي
ᳱ رفع منشئ 
ᳱ مسح المنشئين الاساسين
ᳱ المنشئين الاساسين 
ᳱ غادر 
ᳱ غادر + الايدي
ᳱ اذاعه 
...
send(msg.chat_id_, msg.id_,'ᳱ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Tshake:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Tshake:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'ᳱ المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','ᳱ تم تفعيل المجموعه ~ '..chat.title_..'')
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
Text = 'ᳱ تم تفعيل مجموعه جديده\n'..
'\nᳱ بواسطة ~ '..Name..''..
'\nᳱ ايدي المجموعه ~ `'..IdChat..'`'..
'\nᳱ عدد اعضاء المجموعه *~ '..NumMember..'*'..
'\nᳱ اسم المجموعه ~ ['..NameChat..']'..
'\nᳱ الرابط ~ ['..LinkGp..']'
...
send(msg.chat_id_, msg.id_,'ᳱ المجموعه معطله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','ᳱ تم تعطيل المجموعه ~ '..chat.title_..'')
database:srem(bot_id..'Tshake:Chek:Groups',msg.chat_id_)  
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if text == '/start' then  
if DevTshake(msg) then
local Text = 'ᳱ مرحبا بك في اوامر المطور الجاهزه'
local keyboard = {
{'الاحصائيات'},
...
Test = 'ᳱ مرحبا انا بوت حماية مجموعهات\nᳱ وضيفتي حماية المجموعات من السبام والتفليش والخ...\nᳱ لتفعيل البوت اضفني الى مجموعاتك قم برفعي مشرف ثم ارسل تفعيل \nᳱ معرف المطور ['..UserName..']'
end 
send(msg.chat_id_, msg.id_, Test) 
end
end
...
send(msg.sender_user_id_,msg.id_,'ᳱ تمت ارسال رسالتك الى ~ ['..UserName..']')    
...
sendText(Id_Sudo,'ᳱ تم ارسال الملصق من ~ ['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')',0,'md') 
return false
...
if text == 'حظر' then
sendText(Id_Sudo,'ᳱ  لشخص » ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\nᳱ  تم حظره من التواصل ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'BaN:In:User',data.id_)  
return false  
end 
if text =='الغاء الحظر' then
sendText(Id_Sudo,'ᳱ الشخص » ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\nᳱ  تم الغاء حظره من التواصل ',msg.id_/2097152/0.5,'md')
...
if text == 'معلومات السيرفر' then
   ioserver =  io.popen([[
         ...
         echo '📟l •⊱ { نظام التشغيل } ⊰•\n*»» '"$linux_version"'*' 
         echo '*------------------------------\n*ᳱ l •⊱ { الذاكره العشوائيه } ⊰•\n*»» '"$memUsedPrc"'*'
         echo '*------------------------------\n*ᳱ l •⊱ { وحـده الـتـخـزيـن } ⊰•\n*»» '"$HardDisk"'*'
         echo '*------------------------------\n*ᳱ l •⊱ { الـمــعــالــج } ⊰•\n*»» '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
         echo '*------------------------------\n*ᳱ l •⊱ { موقـع الـسـيـرفـر } ⊰•\n*»» '`curl http://th3boss.com/ip/location`'*'
         echo '*------------------------------\n*ᳱ l •⊱ { الــدخــول } ⊰•\n*»» '`whoami`'*'
         echo '*------------------------------\n*ᳱ l •⊱ { مـده تـشغيـل الـسـيـرفـر } ⊰•  \n*»» '"$uptime"'*'
         ]]):read('*all')
...
send(msg.chat_id_, msg.id_,'*ᳱ  عدد المجموعات الان ~ '..#group..' مجموعه '..storm..''..taha..'\nᳱ اصبح عدد المجموعات الان ~ '..sendok..' مجموعات*\n')   
end
end
end,nil)
end
...
database:del(bot_id..'Tshake:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'\nᳱ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت خدمي' then
database:set(bot_id..'Tshake:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'\nᳱ تم تعطيل البوت الخدمي') 
end
...
if text == 'الغاء' then   
send(msg.chat_id_, msg.id_,"ᳱ تم الغاء حفظ كليشه ستارت") 
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'ᳱ تم حفظ كليشه ستارت') 
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت' then
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'ᳱ ارسل لي الكليشه الان') 
return false
end
if text == 'حذف كليشه ستارت' then
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'ᳱ تم حذف كليشه ستارت') 
end
if text == ("مسح قائمه العام") and DevTshake(msg) then
database:del(bot_id.."Tshake:GBan:User")
send(msg.chat_id_, msg.id_, "\nᳱ تم مسح قائمه العام")
...
local Teext = "ᳱ   تم الغاء الامر بنجاح ."
database:del(bot_id..":usernewsudo:"..msg.sender_user_id_)
...
if msg.sender_user_id_ == tonumber(sudoo) then 
local Texxt = "ᳱ   حسننا الان يمكنك ارسال معرف المطور الاساسي الجديد ..."
keyboard = {} 
...
local Teext =[[
ُ〝 يوجد في البوت 5 قوائم للأوامر 〞
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
ُ𓆩 م1 تخص اوامر الحماية  𓆪
ُ𓆩 م2 تخص الادمنيه 𓆪
ُ𓆩 م3 تخص المدراء  𓆪
...
send(msg.chat_id_, msg.id_,"ᳱ تم ازالة الامر من المجموعه")  
else
send(msg.chat_id_, msg.id_,"ᳱ لا يوجد امر بهاذا الاسم تاكد من الامر واعد المحاوله")  
end
...
Reply_Status(result,result.sender_user_id_,"reply","ᳱ قام بالتعديل على الميديا")  
...
if Tshake_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","ᳱ "..Tshake_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
