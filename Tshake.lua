...
Text = [[
اهــلـا بـكـ فـــي ســورس الــفـا🖥.
ـ•––ᴀ–––––––––ʟ––•ـ
افضل سورس ف الـتـلـيجـرام 💎.
ـ•––ғ–––––––––ᴀ––•ـ
سـرعه ، امـان ، حـمايـه عالميـه🛡.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'مطورين السورس', url="https://t.me/U_ALFA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '◍ هو الخنزير ده اللي ضافك ← '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,'◍ نت دخلت عبر الرابط يباشا اصحي كده اومال.') 
end
end,nil)
else
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ افسح التنين 😂😉 ](t.me/AKJA0)') 
return false
end
end
end
...
if text == 'بف' then
Tshake = "هاجي معاكوا اشطا.!"
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'برايفت' then
Tshake = "هاجي معاكوا فل."
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'باي' then
Tshake = "خد الباب وراك عشان بنام ب البوكسر."
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'تع بف' then
Tshake = "هاجي معاكوا خلصا.؟"
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'تقييد' then
Tshake = "مشاهده ممتعه يباشا."
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'خخخخخ' then
Tshake = "كسمك"
...
if text == '💔' then
Tshake = "يعيني دا البت خزوقته."
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == '🙂' then
Tshake = "وسع وسع للنكد"
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == '🌝' then
Tshake = "🌚"
...
if text == 'شوف' then
Tshake = "• شَُشَُـﮧﮧوٍّ໑فِٰ 🌝🌝ֆ"
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'مساء الخير' then
Tshake = "• مٍٰسٌٍـﮧاَٰء اَٰلْٰحٌٰـﮧبٌِٰ يَٰحٌٰہبٌِٰحٌٰہبٌِٰ🌛🔥ֆ"
send(msg.chat_id_, msg.id_, 1, Tshake, 1, 'md')
end
if text == 'جافا' then
Tshake = "@UU_AK0"
